                              ...
                              const uint32_t Lf, const float ram_budget_ratio, const bool use_detailed_stats)
{
    ...
    {
        ram_budget = full_index_ram * ram_budget_ratio / (1024 * 1024 * 1024);
        diskann::cout << "Forcing RAM budget to " << ram_budget
                      << "GB (" << ram_budget_ratio * 100 << "% of full index size)" << std::endl;
    }
...
// This code should only be available in the "build" DLL.
    ...
    diskann::build_merged_vamana_index<T, LabelT>(data_file_to_use.c_str(), diskann::Metric::L2, L, R, p_val,
                                                  ...
                                                  labels_to_medoids_path, universal_label, Lf, ram_budget_ratio,
                                                  use_detailed_stats);
